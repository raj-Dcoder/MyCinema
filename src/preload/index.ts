...
const api = {
  ...
  fetchTrendingNetflix: (type: 'movie' | 'series') => ipcRenderer.invoke('fetch-trending-netflix', type),
  fetchTrendingPrimeVideo: (type: 'movie' | 'series') => ipcRenderer.invoke('fetch-trending-prime-video', type),
  fetchTrendingJioHotstar: (type: 'movie' | 'series') => ipcRenderer.invoke('fetch-trending-jiohotstar', type),
  fetchTrendingAppleTv: (type: 'movie' | 'series') => ipcRenderer.invoke('fetch-trending-apple-tv', type),
  fetchTrendingHboMax: (type: 'movie' | 'series') => ipcRenderer.invoke('fetch-trending-hbo-max', type),
