...
import { ChevronRight, Play, Download, Magnet, Music, Sparkles } from 'lucide-react'
  ...
  slides: [
    {
      ...
      icon: Play,
      kicker: 'Streaming',
      headline: 'Press play. Start watching.',
      highlight: 'watching',
      support: 'Any magnet now streams in seconds with a live loading screen — no full download wait.',
      signal: 'Instant',
      cta: 'Watch now',
      mood: {
        name: 'instant',
        gradient: 'from-rose-400 via-red-500 to-orange-800',
        text: 'text-rose-200',
        border: 'border-rose-300/20',
        shadow: 'shadow-[0_0_80px_rgba(244,63,94,0.25)]',
        backdrop: 'radial-gradient(ellipse at 50% 0%, rgba(244,63,94,0.14), transparent 60%)',
        cursor: 'rgba(244,63,94,0.2)',
      },
    },
    {
      id: 'while-downloading',
      layout: 'downloads',
      icon: Download,
      kicker: 'Downloads',
      headline: 'Episodes play while downloading.',
      highlight: 'downloading',
      support: 'Jump into any episode mid-download and keep watching while the rest finishes quietly.',
      signal: 'No waiting',
      cta: "I'm in",
      mood: {
        name: 'downloading',
    ...
    },
    {
      ...
      icon: Magnet,
      kicker: 'Sources',
      headline: 'Best magnet rises first.',
      highlight: 'Best',
      support: 'Sources now rank by health, quality, and codec — HEVC picks float up, duds sink.',
      signal: 'Ranked',
      cta: 'Nice',
      mood: {
        name: 'sources',
        ...
        backdrop: 'radial-gradient(ellipse at 50% 0%, rgba(168,85,247,0.14), transparent 60%)',
    ...
    },
    {
      ...
      icon: Music,
      kicker: 'Audio',
      headline: 'Sound stays glued to picture.',
      highlight: 'glued',
      support: 'Track switches and seeks re-sync instantly, with drift correction keeping dialogue locked.',
      signal: 'In sync',
      cta: 'Try it',
      mood: {
        name: 'audio',
    ...
    },
    {
      ...
      icon: Sparkles,
      kicker: 'Polish',
      headline: 'A calmer, steadier player.',
      highlight: 'steadier',
      support: 'No bookmark clutter, no jumping buttons, smoother subtitles — just press play and relax.',
      signal: 'Clean',
      cta: "Let's go",
      mood: {
        name: 'polish',
        ...
        backdrop: 'radial-gradient(ellipse at 50% 0%, rgba(250,204,21,0.12), transparent 60%)',
        cursor: 'rgba(250,204,21,0.2)',
      },
    },
  ],
}
