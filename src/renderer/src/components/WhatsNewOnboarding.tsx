...
import { Sparkles, Sliders, Users, ChevronRight, SkipForward, Zap } from 'lucide-react'
  ...
  slides: [
    {
      ...
      icon: SkipForward,
      kicker: 'Transitions',
      headline: 'Seamless episode flow.',
      highlight: 'Seamless',
      support: 'Cross-fade between episodes with a Netflix-style card and a glowing perimeter progress ring.',
      signal: 'v1.30.0',
      cta: 'Show me',
      mood: {
        name: 'cinematic',
        gradient: 'from-indigo-500 via-purple-600 to-fuchsia-900',
        text: 'text-purple-200',
        border: 'border-purple-400/20',
        shadow: 'shadow-[0_0_80px_rgba(168,85,247,0.25)]',
        backdrop: 'radial-gradient(ellipse at 50% 0%, rgba(168,85,247,0.12), transparent 60%)',
    ...
    },
    {
      ...
      icon: Sparkles,
      kicker: 'Card',
      headline: 'Smart preview, clean skip.',
      highlight: 'Smart preview',
      support: 'The next-episode card shows TMDB art and name, then auto-skips credits at just the right moment.',
      signal: 'Auto',
      cta: 'Nice',
      mood: {
        name: 'social',
    ...
    },
    {
      ...
      icon: Zap,
      kicker: 'Reliability',
      headline: 'Faster, smoother, snappier.',
      highlight: 'Faster',
      support: 'Auto-skip always fires, no more double skips, and network timeouts doubled for fewer hiccups.',
      signal: 'Done',
      cta: 'Watch now',
      mood: {
        name: 'celebrate',
