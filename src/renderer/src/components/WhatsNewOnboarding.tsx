...
import { ChevronRight, Zap, Compass, Filter, Trophy } from 'lucide-react'
  ...
  slides: [
    {
      ...
      icon: Compass,
      kicker: 'Discovery',
      headline: 'Curated sections, zero noise.',
      highlight: 'Curated',
      support: 'Regional and OTT sections show exactly the right content — Netflix, Prime, JioHotstar, Apple, and more.',
      signal: 'v1.31.0',
      cta: 'Explore',
      mood: {
        name: 'discovery',
    ...
    },
    {
      ...
      icon: Filter,
      kicker: 'Precision',
      headline: 'Exactly what you asked for.',
      highlight: 'Exactly',
      support: 'Indian titles, Kdramas, Anime, and platform exclusives — filtered by origin and streaming availability.',
      signal: 'Verified',
      cta: 'Locked in',
      mood: {
        name: 'precision',
    ...
    },
    {
      ...
      icon: Trophy,
      kicker: 'Trending',
      headline: 'Fresh hits, ranked first.',
      highlight: 'Fresh',
      support: 'OTT sections rank the newest popular releases — no decade-old classics crowding the top.',
      signal: 'Hot',
      cta: 'Show me',
      mood: {
        name: 'trending',
    ...
    },
    {
      ...
      icon: Zap,
      kicker: 'Speed',
      headline: 'One tap, instant refresh.',
      highlight: 'instant',
      support: 'Every section re-fetches its latest with one click — and the home screen loads smoother than ever.',
      signal: 'Snappy',
      cta: "Let's go",
      mood: {
        name: 'speed',
